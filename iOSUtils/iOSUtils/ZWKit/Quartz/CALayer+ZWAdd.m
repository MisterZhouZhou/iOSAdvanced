...
- (void)addAnimationWithDuration:(NSTimeInterval)duration transitionType:(NSString *)type  curve:(UIViewAnimationCurve)curve {
//    CATransition *anima = [CATransition animation];
//    anima.type          = type;//设置动画的类型
...
//    [kAppWindow.layer addAnimation:anima forKey:@"revealAnimation"];
    ...
    [self addAnimation:transition forKey:@"revealAnimation"];
}
